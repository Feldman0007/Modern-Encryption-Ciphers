...
unsigned char* AES::encrypt(const unsigned char* plainText)
{
	...
	memset(enc_out, 0, 17);
	bool success = AES_ecb_encrypt(aes_input, enc_out, &enc_key, AES_ENCRYPT);
	return NULL;	
}
...
unsigned char* AES::decrypt(const unsigned char* cipherText)
{
	...
	memset(dec_out, 0, 17);
	bool success = AES_ecb_encrypt(enc_out, dec_out, &dec_key, AES_DECRYPT);
